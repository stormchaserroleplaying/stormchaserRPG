...
**Stamina:** 34 + 5 for each mana spent above 4

**Damage Reduction:**  1 + 1 for each mana spent above 4

**Damage Resistances:** acid (Water only); electric and sonic (Air only); piercing and slashing (Earth only)
...
**Speed:** 30 feet; burrow 30 feet (Earth only); fly 30 feet, hover (Air only); swim 30 feet (Water only)
...
### Other
* [Darkvision](https://stormchaserroleplaying.com/stormchaserRPG/General/Awareness/Special/#darkvision) 60 feet
* Awareness 10 (1d20)
* Languages: Primordial, understands languages you speak
