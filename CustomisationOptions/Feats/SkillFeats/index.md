...
* During a short rest, you can clean and bind the wounds of up to six willing beasts and humanoids. Make a DC 15 Wisdom (Medicine) check for each creature. On a success, if a creature spends a Recovery Die during this rest, that creature can forgo the roll and instead regain the maximum number of stamina the die can restore. A creature can do so only once per rest.
