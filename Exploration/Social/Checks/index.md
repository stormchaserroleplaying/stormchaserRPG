...
This section provides a structured way to resolve a social interaction.

## 1. Starting Attitude
Choose the starting attitude of a creature the adventurers are interacting with: helpful, friendly, indifferent, unfriendly, or hostile.

A **helpful** creature considers you a close ally and will generally act towards your benefit despite minor risks. There is an established trust in you that they will usually believe what you say and take action to aid you whenever possible. While they will assume some risk in their actions for you, anything that would bring harm on them or others close to them may require a successful Charisma check. Examples include a close childhood friend, a patient you rescued from grievous injury, a follower sworn to your service, or a pet you raised from a young age.

A **friendly** creature wants to help the adventurers and wishes for them to succeed. For tasks or actions that require no particular risk, effort, or cost, friendly creatures usually help without question. If an element of personal risk is involved, a successful Charisma check might be required to convince a friendly creature to take that risk. Friendly creatures may include merchants you have helped before, clergy at a local healing church, or someone you have sworn to serve.

An **indifferent** creature might help or hinder the party, depending on what the creature sees as most beneficial. A creature’s indifference doesn’t necessarily make it standoffish or disinterested. Indifferent creatures might be polite and genial, surly and irritable, or anything in between. A successful Charisma check is necessary when the adventurers try to persuade an indifferent creature to do something. It can be safely assumed that the vast majority of people you meet are indifferent to you; they have their own lives and concerns to worry about, and you are often just another face in the crowd to them. 

An **unfriendly** creature sees you as adversarial to its interest. Violence is not typically high on their desires towards you, but they do not wish to see you succeed, either. Convincing them to act against you is typically easier than convincing to give aid. An academic rival, a merchant shorted a prized delivery, or bandits are generally unfriendly (at least in the beginning).
...
## 3. Making the Check (New)
When the adventurers get to the point of their request, demand, or suggestion — or if you decide the conversation has run its course — call for a social skill check. Any character who has actively participated in the conversation can make the check. Depending on how the adventurers handled the conversation, the [Deception](), [Intimidation](), [Persuasion](), [Socialise](), or [Streetwise]() skill might apply to the check. Once the player's skill is chosen, the DC must be determined. A target's willingness to listen will always start with their attitude towards the player(s).

| Target's Attitude | DC |
|:-----------------:|:--:|
| Helpful           | 0  |
| Friendly          | 10 |
| Indifferent       | 15 |
...
Once the attitude and baseline DC is understood, the next step is to determine the attribute supporting the NPC's DC; this will often be Intelligence, Wisdom, or Charisma. Remember that the NPC's skill proficiency does not necessarily define the supporting attribute. Let's look at the following example.

An adventuring party has found a deep-seated rot in the local farmlands. They receive an audience with the regional lord on the matter. The party's druid, being the most knowledgeable about agriculture, takes the lead. They speak on the findings, how crops are affected, and what can be done. In the end, though, they need the lord to lend support. The GM determines that Nature is the most appropriate skill proficiency being "targeted". There are a few ways the party can lean on different attributes of the lord to adjust the DC.
     - Speaking to the lord's vast (or limited) knowledge of agriculture (Intelligence)
     - The broad benefits or consequences of problems on their lands or neighboring territories (Wisdom)
     - The perception of them in the eyes of their subjects and peers (Charisma)

Once the appropriate attribute is determined, the NPC's modifier is applied to the DC - A positive modifier will increase the DC while a negative one will decrease the DC.

Once the baseline DC is determined, the GM decides on the applicable skill and proficiency to "defend" with. Many times this will be the Insight skill where players are trying to get something, but other skills may apply. If a player wants to debate an archmage on matters of metaphysical constructs, the target may use their Arcana proficiency instead. 

| Social Check Adjustment | DC Modifier |
|:----------------------------:|:--------|
| Target's attitude is Helpful | -2d |
