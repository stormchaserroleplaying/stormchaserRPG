...
Choose any number of creatures within range. For the duration, each target has +1d on Wisdom defence checks and [recovery checks](https://stormchaserroleplaying.com/stormchaserRPG/General/Stamina/Recovery/) and regains the maximum number of Stamina possible from any magical healing.
...
**Range:** Touch<br>
**Components:** V, S, M *(Powdered diamond worth at least 200 GP, which the spell consumes)*<br>
...
The glyph is nearly imperceptible and requires a successful Investigation check vs your warding spell skill.
...
**Explosive Rune.** When triggered, the glyph erupts with magical energy in a 20-foot-radius Sphere centered on the glyph. Each creature in the area makes a Dexterity check against your Warding DC. Creatures take 5d8 Acid, Cold, Fire, Lightning, or Thunder damage (your choice when you create the glyph) on a failed check or half as much damage on a successful one.
