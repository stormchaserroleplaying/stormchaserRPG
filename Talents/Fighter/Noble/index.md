...
You gain +1d on weapon attack rolls until the end of the current turn. When you do so, you also gain 1dR temporary stamina.
...
You can use Wisdom instead of Charisma whenever you make a [Persuasion](https://stormchaserroleplaying.com/stormchaserRPG/Skills/Persuasion) check.
...
Additionally, the temporary stamina granted by your Fighting Spirit increases to 2dR.
...
The first time that you would take damage that reduces you to 0 stamina and doesn't kill you outright, you can delay falling [unconscious](https://stormchaserroleplaying.com/stormchaserRPG/Conditions/Unconscious). You immediately interrupt the current turn to take an extra turn. 

While you have 0 stamina during that extra turn, taking damage causes death saving throw failures as normal, and three death saving throw failures can still kill you. When the extra turn ends, you fall [unconscious](https://stormchaserroleplaying.com/stormchaserRPG/Conditions/Unconscious) if you still have 0 hit points.
