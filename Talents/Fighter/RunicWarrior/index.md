...
| Giant's Might    | 5  | Giant Language (Accented) |
...
#### **Cost:** 5 Character Points<br>**Prerequisite:** Smith's Tools Proficiency, Giant Language (Broken)
...
While wearing or carrying an object inscribed with this rune, you have +1d on [Deception](https://stormchaserroleplaying.com/stormchaserRPG/Skills/Deception/) and [Sleight of Hand](https://stormchaserroleplaying.com/stormchaserRPG/Skills/SleightofHand/) checks.
...
In addition, when you hit a creature with an attack using a weapon, you can invoke the rune to summon fiery shackles. The target takes an extra 2dM fire damage, and, if the attack roll exceeds its Strength defence, it is [restrained](https://stormchaserroleplaying.com/stormchaserRPG/Conditions/Restrained/) for 1 minute. While [restrained](https://stormchaserroleplaying.com/stormchaserRPG/Conditions/Restrained/) by the shackles, the target takes 2dM fire damage at the start of each of its turns. The target can repeat the defence check at the end of each of its turns, banishing the shackles on a success. 
...
While wearing or carrying an object inscribed with this rune, you benefit from +1d on [Animal Handling](https://stormchaserroleplaying.com/stormchaserRPG/Skills/AnimalHandling/) and [Intimidation](https://stormchaserroleplaying.com/stormchaserRPG/Skills/Intimidation/) checks.
...
While wearing or carrying an object inscribed with this rune, you benefit from +1d on [Arcana](https://stormchaserroleplaying.com/stormchaserRPG/Skills/Arcana/)  checks and you can't be surprised as long as you aren't [incapacitated](https://stormchaserroleplaying.com/stormchaserRPG/Conditions/Incapacitated/).

In addition, you can invoke the rune using 1 action to enter a prophetic state for 1 minute or until you're [incapacitated](https://stormchaserroleplaying.com/stormchaserRPG/Conditions/Incapacitated/). Until the state ends, the first time that you or another creature that you can see within 60 feet of you makes an attack roll, defence check, or skill check, a friendly creature benefits from +1d to the roll and a hostile creature suffers -1d. On your turn you can designate which creatures can be targeted by this effect.
...
- Once on each of your turns, one of your attacks with a weapon or an unarmed strike can deal an extra 1dM damage to a target on a hit.
...
Once per round, the first time that an allied creature that you can see within 60 feet of you is hit by an attack roll, you impart -1d on the attack. On your turn you can designate which creatures are can be protected and/or hindered by this effect.
...
When you gain this feature, roll 3d4. You grow a number of inches in height equal to the roll. You also count as one size larger when determining the weight you can push, pull, drag, or lift.

Moreover, the extra damage that you deal with your Giant's Might feature increases to 2dM.
...
As a result, the extra damage you deal with the Giant's Might feature increases to 3dM. Moreover, when you use that feature, your size can increase to Huge, and while you are that size, your reach increases by 5 feet.
