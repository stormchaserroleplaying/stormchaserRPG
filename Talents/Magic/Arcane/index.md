...
#### Characters with Divine and Arcane Spellcasting
If you have both Divine and Arcane spellcasting, you only receive the mana pool of your highest spell level. You still receive all prepared spells from each spellcasting talent, and you can obtain bonus spells for each spellcasting talent from any branch or tree which you have talents already.
...
- 4 Arcane spells known, plus 2 bonus spells from any branch/tree which the character has talents
- 4 levels of Divine spells prepared, plus 2 bonus spells from any branch/tree which the character has talents
- Mana Pool of 3

If the character were to increase either Divine or Arcane spellcasting, they would gain the additional spell known or prepared, as well as the increased mana pool from 3 to 6.  
